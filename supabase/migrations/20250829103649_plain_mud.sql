/*
  # Comprehensive Backend Setup for MockInvi
  
  This migration ensures all backend functionality works properly by:
  1. Creating missing tables and columns
  2. Setting up proper RLS policies
  3. Creating essential database functions
  4. Establishing foreign key relationships
  5. Adding performance indexes
  6. Setting up storage buckets and policies
*/
...
DROP POLICY IF EXISTS "Admins can access credentials" ON public.admin_credentials;
...
DROP POLICY IF EXISTS "System can insert user certificates" ON public.user_certificates;
...
DROP POLICY IF EXISTS "System can manage user learning data" ON public.user_learning;
...
DROP POLICY IF EXISTS "System can manage certificate management" ON public.course_certificate_management;
...
DROP POLICY IF EXISTS "System can manage interview sessions" ON public.interview_sessions;

CREATE POLICY "System can manage interview sessions" ON public.interview_sessions
FOR ALL WITH CHECK (true);

-- Interview reports policies
DROP POLICY IF EXISTS "Users can view their own reports" ON public.interview_reports;
DROP POLICY IF EXISTS "System can manage interview reports" ON public.interview_reports;
...
DROP POLICY IF EXISTS "Users can view their own usage" ON public.user_interview_usage;
DROP POLICY IF EXISTS "System can manage interview usage" ON public.user_interview_usage;
...
DROP POLICY IF EXISTS "System can manage user reports" ON public.user_reports;
...
DROP POLICY IF EXISTS "Pro users can view interview resources" ON public.interview_resources;
...
-- =====================================================
-- 7. CREATE UNIFIED CERTIFICATE VIEW
-- =====================================================
...
-- =====================================================
-- 9. INSERT DEFAULT DATA IF MISSING
-- =====================================================
...
-- =====================================================
-- 10. CREATE STORAGE BUCKETS AND POLICIES
-- =====================================================
...
SELECT 'Comprehensive backend setup completed successfully!' as final_status;